...
class _MeetingDetailScreenState extends State<MeetingDetailScreen> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      final currentUserId = authService.member?['id'];
        ...
        if (currentUserId != null) {
          try {
            ...
            if (adminsResponse.statusCode == 200) {
              ...
              isClubAdmin = admins.any((a) => a['memberId'] == currentUserId);
            }
          } catch (e) {
            debugPrint('Failed to check club admin status: $e');
          }
        }
  ...
  bool _isAdmin() {
    ...
    // User is admin if they are PLATFORM_ADMIN or a Club Admin of this specific club
    return role == 'PLATFORM_ADMIN' || _isClubAdmin;
  }
