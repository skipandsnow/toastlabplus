...
| 功能 | 狀態 | 說明 |
|------|------|------|
| **模板上傳** | ✅ 完成 | 上傳 Excel 至 GCS，存入 Cloud SQL |
| **AI 模板解析** | ✅ 完成 | 使用 Gemini 2.5 Flash 辨識角色變數位置 (`variable_mappings`) |
| **角色報名** | ✅ 完成 | 會員可報名 TME, Speaker, Evaluator 等角色 |
| **Agenda 產生** | ✅ 完成 | 讀取原始 Excel 模板，填入角色資料，產生 Excel 下載 |
| **動態 Speaker 行** | ✅ 完成 | 自動偵測隱藏的 Speaker 行並取消隱藏 |
| **Template-Based Role Slots** | ✅ 完成 | 新 Meeting 只建立模板中存在的角色 |
| **結構化 UI 編輯** | 🚧 待開發 | 可視化編輯模板區塊與順序 |
| **PDF 匯出** | 🚧 待開發 | 將 Excel 轉換為 PDF |
